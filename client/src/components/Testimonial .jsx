                ...
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className='bg-white p-6 rounded-xl shadow'>
                        ...
                        <p className='text-gray-500 max-w-90 mt-4'>
                            "{testimonial.review || "I've used many booking platforms before, but none compare to the personalized experience QuickStay provides."}"
                        </p>
                        <ReviewAnalyzer
                            reviewText={testimonial.review || "I've used many booking platforms before, but none compare to the personalized experience QuickStay provides."}
